...
alias gitconRW="git config --global user.name 'rwbot'; git config --global user.email 'rwbotx@gmail.com'"
alias gitconKIRK="git config --global user.name 'Kirk Boyd'; git config --global user.email 'kirkland.boyd@trincoll.edu'"